...
class CategoryItemAdapter(private val mContext: Context, private val list: ArrayList<DataBin>,val parent: CategoryItems) : RecyclerView.Adapter<CategoryItemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(data.added_to_cart=="1"){
            holder.qty_layout.visibility=View.VISIBLE
            holder.btnAdd.visibility=View.GONE
            holder.qty.setText(data.qty)
        }else{
        ...
        holder.btnAdd.setOnClickListener{
            holder.btnAdd.visibility=View.GONE
            holder.qty_layout.visibility=View.VISIBLE
            parent.updateCartCount(data.product_id.toString(),"1")
        }
        holder.btnPlus.setOnClickListener{
            ...
            parent.updateCartCount(data.product_id.toString(),qty_value.toString())
        }
        holder.btnMinus.setOnClickListener{
            ...
            if(qty_value>1){
                ...
                parent.updateCartCount(data.product_id.toString(),"0")
                holder.btnAdd.visibility=View.VISIBLE
                holder.qty_layout.visibility=View.GONE
            }
            holder.qty.text = qty_value.toString()
